    ...
    <header class="app-header fixed-top">	   	            
        ...
        <div id="app-sidepanel" class="app-sidepanel"> 
	        ...
	        <div class="sidepanel-inner d-flex flex-column">
		        ...
		        <img class="logo-icon me-2" src="app-logo.svg" alt="logo"><span class="logo-text">GYM PARK</span>
					    ...
					    <div class="app-card app-card-stat shadow-sm h-100">
						    <div class="app-card-body p-3 p-lg-4">
							    ...
							    <div class="stats-figure"><%Class.forName("com.mysql.cj.jdbc.Driver"); 
							    		Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/web", "root", "rootpassword");
 ...
 <path fill-rule="evenodd" d="M8 1a.5.5 0 0 1 .5.5v11.793l3.146-3.147a.5.5 0 0 1 .708.708l-4 4a.5.5 0 0 1-.708 0l-4-4a.5.5 0 0 1 .708-.708L7.5 13.293V1.5A.5.5 0 0 1 8 1z"/>
  ...
  <path fill-rule="evenodd" d="M8 1a.5.5 0 0 1 .5.5v11.793l3.146-3.147a.5.5 0 0 1 .708.708l-4 4a.5.5 0 0 1-.708 0l-4-4a.5.5 0 0 1 .708-.708L7.5 13.293V1.5A.5.5 0 0 1 8 1z"/>
					        ...
					        <div class="app-card-header p-3">
						        <div class="row justify-content-between align-items-center" >
							        <div class="col-auto" style="width: 900px">
						                <h4 class="app-card-title">Column Chart</h4>
							        </div><!--//col-->
							        <div class="col-auto">
	...
	try{
		...
		Connection con2 = DriverManager.getConnection("jdbc:mysql://localhost:3306/web", "root", "rootpassword");
		Statement s2 = con.createStatement();
		ResultSet r2 = s2.executeQuery("SELECT DATE_FORMAT(date,'%Y-%m-%d'),SUM(totalAmount) FROM orders GROUP BY MONTH(date)");
		while(r2.next()){
			map = new HashMap<Object,Object>(); 
			map.put("label", r2.getDate(1));
