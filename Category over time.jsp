 ...
 <path fill-rule="evenodd" d="M8 1a.5.5 0 0 1 .5.5v11.793l3.146-3.147a.5.5 0 0 1 .708.708l-4 4a.5.5 0 0 1-.708 0l-4-4a.5.5 0 0 1 .708-.708L7.5 13.293V1.5A.5.5 0 0 1 8 1z"/>
  ...
  <path fill-rule="evenodd" d="M8 1a.5.5 0 0 1 .5.5v11.793l3.146-3.147a.5.5 0 0 1 .708.708l-4 4a.5.5 0 0 1-.708 0l-4-4a.5.5 0 0 1 .708-.708L7.5 13.293V1.5A.5.5 0 0 1 8 1z"/>
					        ...
					        <div class="app-card-header p-3">
						        <div class="row justify-content-between align-items-center" >
							        <div class="col-auto" style="width: 900px">
						                <h4 class="app-card-title">Spline Chart</h4>
							        </div><!--//col-->
							        <div class="col-auto">
	...
	try{
		...
		ResultSet r2 = s2.executeQuery("SELECT DATE_FORMAT(Date,'%Y-%m-%d'),COUNT(*) FROM customers GROUP BY MONTH(Date)");
		while(r2.next()){
	...
	<script type="text/javascript">
		...
		var chart = new CanvasJS.Chart("chartContainer", {
			...
			exportEnabled: true,
			title: {
				text: "Customers Over time graph"
			},
			axisX: {
				title: "Months"
			},
