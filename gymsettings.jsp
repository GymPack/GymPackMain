...
<%
    ...
    String sql = "Select * from user where Name = '"+session.getAttribute("name")+"'";
    Statement stat = con.createStatement();
    ResultSet result = stat.executeQuery(sql);
    while(result.next()){
        uname = result.getString("Name");
        uemail = result.getString("Email");
...
<%-- 
    Document   : index
    Created on : Jul 30, 2022, 1:25:12 PM
    Author     : Trev
--%>
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            ...
            <div class="row g-4 settings-section">
                <div class="col-12 col-md-4">
                    ...
                    <div class="section-intro">Configure the general settings of the system</div>
                </div>
...
<circle cx="8" cy="4.5" r="1"></circle>
                                    ...
                                    <input type="text" class="form-control" id="setting-input-1" value="GymPack">
                                </div>
                                <div class="mb-3">
                                    <label for="setting-input-2" class="form-label">Contact Name</label>
                                    <input type="text" class="form-control" id="setting-input-2" value="<%=uname%>" required="">
                                </div>
                                <div class="mb-3">
            ...
            <div class="row g-4 settings-section" id ="accounts">
                <div class="col-12 col-md-4">
                    <h3 class="section-title">Account</h3>
                    <div class="section-intro">Change your personal details</div>
                </div>
                <div class="col-12 col-md-8">
                    <div class="app-card app-card-settings shadow-sm p-4">
                        <div class="app-card-body">
                            <form class="settings-form" action="Settings" method="post">                                
                                <div class="mb-3">
                                    <label for="setting-input-2" class="form-label">Personal Email</label>
                                    <input type="email" class="form-control" id="setting-input-4" name="newemail" value="<%=uemail%>" required>
                                </div>
                                <div class="mb-3">
                                    <label for="setting-input-3" class="form-label">Password</label>
                                    <input type="password" class="form-control" id="setting-input-5" name="newpass" value="<%=upass%>" required>
	...
	<link rel="stylesheet" href="package/dist/sweetalert2.css">
        <script type="text/javascript">
            ...
            else if(status === "emailChange"){
                Swal.fire("", "Email changed successfully", "success");
            }
            else if(status === "noChange"){
                Swal.fire("", "No changes have been saved", "error");
            }
        </script>
    </body>
</html>
